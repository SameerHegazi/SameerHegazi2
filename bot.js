...
client.on('guildCreate', guild => {
  ...
  .setDescription(`**
  New Server Add LOCKAT ✅
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("471758319535783947").sendEmbed(embed)
});
...
const adminprefix = "-v";
const devs = ['465433952535052288','471040419334193166'];
client.on('message', message => {
...
client.on('message', message => { 
    ...
    .setFooter(`LOCKAT Bot`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
