...
const devs = ['467857627783626752'];//by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
...
${prefix}queue ⇏  الانجليزية فقط تعمل في هذه الاوامر سيتم اضافة العربي قريبا
...
if(member.voiceChannelID === '471019113460924420') {
...
deny: ['CONNECT']
    ...
    const parent = member.guild.channels.get('471019113460924420').parentID
...
message.guild.members.get(user.id).setVoiceChannel('469070185899360261'); // المكان الي راح ينحطوله بعد ما يصير لهم lock
}  
} catch (error) {
console.log(error)
}
