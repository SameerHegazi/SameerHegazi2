...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['!.invite','!.help','!.help | !.دعوة','By Every','يعمل بواسطة افري'];
    var i = -1;
    var j = 0;
...
if (message.content.startsWith("!.report")) {
          if(!message.channel.guild) return message.reply(' !.info-report لمعرفة كيفية إرسال الرسالة قم بكتابةالأمر')
      if (message.author.bot) return;
