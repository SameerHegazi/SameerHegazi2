...
var prefix = "*"
client.on('ready', () => {
  client.user.setGame('*help | *invite','https://www.twitch.tv/justrobertooo');
  console.log('---------------');
...
Server support: https://discord.gg/m3MusYW
...
bot invite link: https://discordapp.com/api/oauth2/authorize?client_id=461102758515310603&permissions=8&scope=bot
