...
client.on('ready', function(){
    ...
    setInterval(function (){
        ...
        i = i+j;
        client.user.setGame(setGame[i],`Ark`);
    }, ms);100000
...
if (message.content === 'invite') {
      message.author.send('https://discordapp.com/api/oauth2/authorize?client_id=466839312764370950&permissions=8&scope=bot').catch(e => console.log(e.stack));
...
client.login('NDY2ODM5MzEyNzY0MzcwOTUw.DiiCOw.cbnUPQcfWBQdYKVi0xF6WwltPLo');
